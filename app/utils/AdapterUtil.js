...
//标题栏的高度
export const titleHeight = unitWidth * 90 + statusBarHeight;
//字体缩放比例，一般情况下不用考虑。
...
export const textSize24 = unitWidth * 24
export const textSize18 = unitWidth * 18
export const textSizebig = unitWidth * 45
